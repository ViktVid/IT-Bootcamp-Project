...
public class ExcelReaderProject { // >> Klasa koja setuje Excel tabelu kao osnovu za primanje, odnosno slanje podataka.
    File file;
    FileInputStream fis;
    XSSFWorkbook wb;
    XSSFSheet sheet;
   ...
   public ExcelReaderProject(String filePath) throws IOException {
